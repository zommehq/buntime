...
// 2. Register fragment web components for micro-frontends
registerFragmentComponents();
...
The dashboard supports micro-frontends via Fragment:

[source,typescript]
----
import { registerFragmentComponents } from "@buntime/fragment/client";
