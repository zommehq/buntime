...
NOTE: Atualmente a versão é hardcoded como "1.0.0". Futuramente virá de `buntime.jsonc` ou `package.json`.
...
Rotas especiais para micro-frontends usando `fragment-outlet`:
