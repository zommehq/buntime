...
import type { DurableObject } from "~/helpers/durable-api";
import { durableApi } from "~/helpers/durable-api";
...
function DurableDetailPage() {
  ...
  useEffect(() => {
    const loadObject = async () => {
      setLoading(true);
      try {
        const result = await durableApi.get(id);
        setObject(result);
      } catch (error) {
