...
//
// This script:
// 1. Reads charts/buntime/questions.base.yaml (runtime core questions)
...
// 4. Writes the combined result to charts/buntime/questions.yml
//
...
# Source: charts/buntime/questions.base.yaml + plugins/*/manifest.yaml
#
