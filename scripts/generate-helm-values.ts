...
//
// This script:
// 1. Reads charts/values.base.yaml (runtime core values)
...
// 4. Writes the combined result to charts/values.yaml
//
...
# Source: charts/values.base.yaml + plugins/*/manifest.yaml
#
