...
import { useFiltersState } from "./data-table-parsers";
import type { ExtendedColumnFilter, FilterOperator } from "./data-table-types";
...
function FilterValueSelector<TData>({ column, value, onSelect }: FilterValueSelectorProps<TData>) {
  ...
  switch (variant) {
    ...
    default: {
      ...
      return (
        <CommandGroup>
          <CommandItem value={value} disabled={isEmpty} onSelect={() => onSelect(value)}>
            {isEmpty ? (
              <>
