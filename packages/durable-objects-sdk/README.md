# @buntime/durable-objects-sdk

Client SDK for Durable Objects in Buntime workers.

## Installation

```bash
bun add @buntime/durable-objects-sdk
```
...
```typescript
import { DurableObject, type DurableObjectState } from "@buntime/durable-objects-sdk";
...
```typescript
import { DurableObjectNamespace } from "@buntime/durable-objects-sdk";
...
- [@buntime/durable-objects](../durable-objects/README.md) - Server extension
