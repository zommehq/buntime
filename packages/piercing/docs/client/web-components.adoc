...
1. Servidor renderiza HTML com fragment-host
   ↓
2. HTML contém <fragment-host src="/p/logs">
   ↓
...
[source]
----
5. Outlet conecta: <fragment-outlet src="/p/logs">
   ↓
...
[source]
----
5. Outlet conecta: <fragment-outlet src="/p/metrics">
   ↓
6. Fragment não encontrado no DOM
   ↓
7. Outlet busca via fetch(/p/metrics)
   ↓
