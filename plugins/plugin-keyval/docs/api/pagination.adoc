...
----
# Primeira página
curl "http://localhost:8000/keyval/api/keys/list/users?limit=10"

# Próxima página
curl "http://localhost:8000/keyval/api/keys/list/users?limit=10&cursor=abc123"

# Ordem reversa
curl "http://localhost:8000/keyval/api/keys/list/users?limit=10&reverse=true"
----
