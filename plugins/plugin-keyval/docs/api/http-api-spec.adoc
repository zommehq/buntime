...
[source,bash]
----
curl -X GET "http://localhost:8000/keyval/api/keys/users/123"
----
...
curl -X GET "http://localhost:8000/keyval/api/keys?prefix=users&limit=50"

# Listar em ordem reversa
curl -X GET "http://localhost:8000/keyval/api/keys?prefix=users&reverse=true"

# Listar com range (de "users/100" até "users/200")
curl -X GET "http://localhost:8000/keyval/api/keys?prefix=users&start=users/100&end=users/200"
----
...
curl -X GET "http://localhost:8000/keyval/api/keys/count"

# Contar chaves com prefixo "users"
curl -X GET "http://localhost:8000/keyval/api/keys/count?prefix=users"
----
...
----
# Primeira página
curl -X GET "http://localhost:8000/keyval/api/keys/paginate?prefix=users&limit=10"

# Próxima página (usando cursor retornado)
curl -X GET "http://localhost:8000/keyval/api/keys/paginate?prefix=users&limit=10&cursor=dXNlcnMvMDAy"
----
...
[source,bash]
----
curl -X GET "http://localhost:8000/keyval/api/queue/poll"
----
...
[source,bash]
----
curl -X GET "http://localhost:8000/keyval/api/queue/stats"
----
...
curl -X GET "http://localhost:8000/keyval/api/queue/dlq?limit=50"

# Segunda página (offset 50)
curl -X GET "http://localhost:8000/keyval/api/queue/dlq?limit=50&offset=50"
----
...
[source,bash]
----
curl -X GET "http://localhost:8000/keyval/api/queue/dlq/01J9X3K2M5N7P8Q9R0S1T2V3W4"
----
...
[source,bash]
----
curl -X POST "http://localhost:8000/keyval/api/queue/dlq/01J9X3K2M5N7P8Q9R0S1T2V3W4/requeue"
----
...
[source,bash]
----
curl -X DELETE "http://localhost:8000/keyval/api/queue/dlq/01J9X3K2M5N7P8Q9R0S1T2V3W4"
----
...
curl -N "http://localhost:8000/keyval/api/watch?keys=config,settings"
...
curl -X GET "http://localhost:8000/keyval/api/watch/poll?keys=users/123,posts/456"

# Verificações subsequentes (passando versionstamps anteriores)
curl -X GET "http://localhost:8000/keyval/api/watch/poll?keys=users/123,posts/456&versionstamps=00000000000000010000,00000000000000020000"
----
...
curl -N "http://localhost:8000/keyval/api/watch/prefix?prefix=users"
...
curl -X GET "http://localhost:8000/keyval/api/watch/prefix/poll?prefix=users"

# Verificação subsequente (passando versionstamps anteriores)
curl -X GET "http://localhost:8000/keyval/api/watch/prefix/poll?prefix=users&versionstamps=users/001:00000000000000010000,users/002:00000000000000020000"
----
...
[source,bash]
----
curl -X GET "http://localhost:8000/keyval/api/indexes"
----
...
curl -X GET "http://localhost:8000/keyval/api/search?prefix=products&query=smartphone"

# Buscar com limite de resultados
curl -X GET "http://localhost:8000/keyval/api/search?prefix=products&query=phone%20case&limit=10"

# Buscar posts
curl -X GET "http://localhost:8000/keyval/api/search?prefix=posts&query=tutorial%20react"
----
...
[source,bash]
----
curl -X GET "http://localhost:8000/keyval/api/metrics"
----
...
[source,bash]
----
curl -X GET "http://localhost:8000/keyval/api/metrics/prometheus"
----
...
RESPONSE=$(curl -s "http://localhost:8000/keyval/api/watch/poll?keys=users/123,posts/456")
echo "$RESPONSE"
...
curl -s "http://localhost:8000/keyval/api/watch/poll?keys=users/123,posts/456&versionstamps=$VERSIONSTAMPS"
----
