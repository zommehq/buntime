...
[source,bash]
----
curl -X GET "http://localhost:4000/_/plugin-keyval/keys/users/123"
----
...
[source,bash]
----
curl -X POST "http://localhost:4000/_/plugin-keyval/keys/batch" \
...
----
# Set sem TTL
curl -X PUT "http://localhost:4000/_/plugin-keyval/keys/users/123" \
  -H "Content-Type: application/json" \
  -d '{"name": "João", "email": "joao@example.com"}'

# Set com TTL de 1 hora (3600000 ms)
curl -X PUT "http://localhost:4000/_/plugin-keyval/keys/sessions/abc?expireIn=3600000" \
  -H "Content-Type: application/json" \
...
**Modo 1: Delete simples**

Sem body, deleta a chave exata fornecida na URL.

NOTE: O método delete() remove a chave especificada E todas as sub-chaves (filhos) que começam com esse prefixo. Por exemplo, deletar `["users", "123"]` irá remover também `["users", "123", "profile"]`, `["users", "123", "settings"]`, etc.

**Modo 2: Delete com filtro WHERE**
...
[source,bash]
----
# Delete simples de uma chave
curl -X DELETE "http://localhost:4000/_/plugin-keyval/keys/users/123"

# Delete com filtro (deleta entradas com status = "completed")
curl -X DELETE "http://localhost:4000/_/plugin-keyval/keys/tasks" \
  -H "Content-Type: application/json" \
...
curl -X GET "http://localhost:4000/_/plugin-keyval/keys?prefix=users&limit=50"

# Listar em ordem reversa
curl -X GET "http://localhost:4000/_/plugin-keyval/keys?prefix=users&reverse=true"

# Listar com range (de "users/100" até "users/200")
curl -X GET "http://localhost:4000/_/plugin-keyval/keys?prefix=users&start=users/100&end=users/200"
----
...
curl -X POST "http://localhost:4000/_/plugin-keyval/keys/list" \
  -H "Content-Type: application/json" \
  -d '{
    "prefix": ["users"],
...
curl -X GET "http://localhost:4000/_/plugin-keyval/keys/count"

# Contar chaves com prefixo "users"
curl -X GET "http://localhost:4000/_/plugin-keyval/keys/count?prefix=users"
----
...
----
# Primeira página
curl -X GET "http://localhost:4000/_/plugin-keyval/keys/paginate?prefix=users&limit=10"

# Próxima página (usando cursor retornado)
curl -X GET "http://localhost:4000/_/plugin-keyval/keys/paginate?prefix=users&limit=10&cursor=dXNlcnMvMDAy"
----
...
curl -X POST "http://localhost:4000/_/plugin-keyval/atomic" \
  -H "Content-Type: application/json" \
  -d '{
    "mutations": [
...
----
# Enqueue simples
curl -X POST "http://localhost:4000/_/plugin-keyval/queue/enqueue" \
  -H "Content-Type: application/json" \
...
curl -N "http://localhost:4000/_/plugin-keyval/queue/listen"
----
...
[source,bash]
----
curl -X GET "http://localhost:4000/_/plugin-keyval/queue/poll"
----
...
[source,bash]
----
curl -X POST "http://localhost:4000/_/plugin-keyval/queue/ack" \
  -H "Content-Type: application/json" \
...
[source,bash]
----
curl -X POST "http://localhost:4000/_/plugin-keyval/queue/nack" \
  -H "Content-Type: application/json" \
  -d '{"id": "01J9X3K2M5N7P8Q9R0S1T2V3W4"}'
----
...
[source,bash]
----
curl -X GET "http://localhost:4000/_/plugin-keyval/queue/stats"
----
...
curl -X GET "http://localhost:4000/_/plugin-keyval/queue/dlq?limit=50"

# Segunda página (offset 50)
curl -X GET "http://localhost:4000/_/plugin-keyval/queue/dlq?limit=50&offset=50"
----
...
[source,bash]
----
curl -X GET "http://localhost:4000/_/plugin-keyval/queue/dlq/01J9X3K2M5N7P8Q9R0S1T2V3W4"
----
...
[source,bash]
----
curl -X POST "http://localhost:4000/_/plugin-keyval/queue/dlq/01J9X3K2M5N7P8Q9R0S1T2V3W4/requeue"
----
...
[source,bash]
----
curl -X DELETE "http://localhost:4000/_/plugin-keyval/queue/dlq/01J9X3K2M5N7P8Q9R0S1T2V3W4"
----
...
[source,bash]
----
curl -X DELETE "http://localhost:4000/_/plugin-keyval/queue/dlq"
----
...
----
# Observar uma chave
curl -N "http://localhost:4000/_/plugin-keyval/watch?keys=users/123"

# Observar múltiplas chaves (separadas por vírgula)
curl -N "http://localhost:4000/_/plugin-keyval/watch?keys=config,settings"

# Sem emissão inicial
curl -N "http://localhost:4000/_/plugin-keyval/watch?keys=users/123&initial=false"
----
...
curl -X GET "http://localhost:4000/_/plugin-keyval/watch/poll?keys=users/123,posts/456"

# Verificações subsequentes (passando versionstamps anteriores)
curl -X GET "http://localhost:4000/_/plugin-keyval/watch/poll?keys=users/123,posts/456&versionstamps=00000000000000010000,00000000000000020000"
----
...
curl -N "http://localhost:4000/_/plugin-keyval/watch/prefix?prefix=users"

# Limitar a 50 chaves
curl -N "http://localhost:4000/_/plugin-keyval/watch/prefix?prefix=users&limit=50"
----
...
curl -X GET "http://localhost:4000/_/plugin-keyval/watch/prefix/poll?prefix=users"

# Verificação subsequente (passando versionstamps anteriores)
curl -X GET "http://localhost:4000/_/plugin-keyval/watch/prefix/poll?prefix=users&versionstamps=users/001:00000000000000010000,users/002:00000000000000020000"
----
...
curl -X POST "http://localhost:4000/_/plugin-keyval/indexes" \
  -H "Content-Type: application/json" \
  -d '{
    "prefix": ["products"],
    "options": {
...
[source,bash]
----
curl -X GET "http://localhost:4000/_/plugin-keyval/indexes"
----
...
curl -X DELETE "http://localhost:4000/_/plugin-keyval/indexes?prefix=products"
----
...
curl -X GET "http://localhost:4000/_/plugin-keyval/search?prefix=products&query=smartphone"

# Buscar com limite de resultados
curl -X GET "http://localhost:4000/_/plugin-keyval/search?prefix=products&query=phone%20case&limit=10"

# Buscar posts
curl -X GET "http://localhost:4000/_/plugin-keyval/search?prefix=posts&query=tutorial%20react"
----
...
curl -X POST "http://localhost:4000/_/plugin-keyval/search" \
  -H "Content-Type: application/json" \
  -d '{
    "prefix": ["products"],
    "query": "phone",
...
[source,bash]
----
curl -X GET "http://localhost:4000/_/plugin-keyval/metrics"
----
...
[source,bash]
----
curl -X GET "http://localhost:4000/_/plugin-keyval/metrics/prometheus"
----
...
- **expireIn:** Número inteiro positivo em milissegundos
...
RESPONSE=$(curl -s "http://localhost:4000/_/plugin-keyval/watch/poll?keys=users/123,posts/456")
echo "$RESPONSE"
...
curl -s "http://localhost:4000/_/plugin-keyval/watch/poll?keys=users/123,posts/456&versionstamps=$VERSIONSTAMPS"
----
